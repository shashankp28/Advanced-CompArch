...
//         instr_count = 1;
//     }
//     void update(long long unsigned instr_ptr, long long unsigned effective_mem_address)
//     {
//         InstructionInfo* ins = static_instr[instr_ptr];

//         for (auto x: ins->read_regs)
//         {
...
//         }
//         for(auto x: is_mem_read){
//             if(store_history[x]!=0){
//                 MEMDEP[instr_count - store_history[x]]++;
//             }
//         }
//         for(auto x: is_mem_write){
//             store_history[effective_mem_address]=instr_count;
//         }
//     }
//     void printRAW()
//     {
